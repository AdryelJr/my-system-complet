...
export function Menu({ setActiveLink, isDarkMode, clickHamb }: any) {
    ...
    return (
        <div className={`container-menu${isDarkMode ? 'dark-theme' : ''} ${clickHamb ? 'clickHamb' : ''}`}>
            <div className='logo'>
                <img width={50} src={imgLogo} alt="logo" />
                <span>My System</span>
            </div>
...
export function Hamb({ onClick, clickHamb }: any) {
    ...
    return (
        <div className={`hamb ${clickHamb ? 'hambAtivo' : ''}`} onClick={onClick}>
            {clickHamb ? <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g id="Menu / Close_MD"> <path id="Vector" d="M18 18L12 12M12 12L6 6M12 12L18 6M12 12L6 18" stroke="#333" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g> </g></svg>
                :
                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
                        <path d="M4 18L20 18" stroke="#333" strokeWidth="2" strokeLinecap="round"></path>
                        <path d="M4 12L20 12" stroke="#333" strokeWidth="2" strokeLinecap="round"></path>
                        <path d="M4 6L20 6" stroke="#333" strokeWidth="2" strokeLinecap="round"></path>
                    </g>
                </svg>
            }
        </div>
